...
public class ImprovedIdGeneratorConfigurationTest {

  @Autowired
  private IdGenerator idGenerator;

  @Test
  public void testThatImprovedIdGeneratorIsUsed() {
    Assert.assertEquals(ImprovedIdGenerator.class, idGenerator.getClass());
  }
}